...
class Alumnomdl {
        ...
        static public function mdlGuardarAlumno($datos) {
            $stmt = Conexion::conectar()->prepare("INSERT INTO infoalumnos (Matricula, Nom, App, Apm, Grup, TutorCel, CelAlum) 
        ...
        static public function obtenerInfoAlumnoDesdeExcel($matricula) {
